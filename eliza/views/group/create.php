<div class="group-create">
    ...
    <form id="group-create" name="Group" action="" method="POST">
      <div class="control-group <?php echo !empty($errors['name']) ? 'error' : '' ?>">
        <label class="control-label" for="Group[name]">Group name:<span class="required">*</span></label>
        <div class="controls">
          <input type="text" name="Group[name]" value='<?php echo !empty($_POST['Group']['name']) ? htmlspecialchars($_POST['Group']['name']) : '' ?>' /><br />
